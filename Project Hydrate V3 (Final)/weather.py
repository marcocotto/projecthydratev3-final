...
def determine_drinking_amount(weather_data):
    ...
    print("The temperature right now is: {}{}".format(temp_celsius_rounded, "°C"))
    temperature_message.set("The temperature right now is: {}{}".format(temp_celsius_rounded, "°C"))
...
weather_label = Label(root, image="")
weather_label.place(relx=0.5, y=160, anchor=tk.CENTER)

weather_title_label = Label(root, image=weather_title_tk)
weather_title_label.place(relx=0.5, y=70, anchor=tk.CENTER)

# Create a dropdown menu for city selection
cities = ["Auckland", "Auckland", "Wellington", "Christchurch", "Hamilton", "Tauranga", "Dunedin", "Palmerston North",
          "Napier", "Nelson", "Rotorua", "New Plymouth", "Whangarei", "Invercargill", "Whanganui", "Gisborne",
          "Lower Hutt", "Upper Hutt", "Wanaka", "Queenstown", "Taupo"]
...
last_updated_variable = StringVar()
last_updated_variable.set("")
...
temperature_label = ttk.Label(root, textvariable=temperature_message, font=("Simplifica", 16, "bold"))
...
fetch_button = ttk.Button(root, text="C H E C K  W E A T H E R", image=button_image_tk, compound="center", command=display_weather)
